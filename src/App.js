...
export default function App() {
  ...
  const startMicMonitoring = async () => {
    ...
    try {
      ...
      const loop = () => {
        ...
        try {
          console.debug("mic rms=", rms.toFixed(4));
        } catch (e) {}
  ...
  return (
    <div className="App">
      ...
      <h1 className="birthdayText">🎂 Happy Birthday Emalena 🎂</h1>
      ...
      {showMessage && (
        <div
          ...
          tabIndex={-1}
        >
          <div className="card" style={{ color: "white", padding: 24, fontSize: 20 }}>
            🎉 Wishing you the happiest birthday, Emalena! 🎉
          </div>
        </div>
      )}
    </div>
